...
//SQL 敘述: 取得 product 資料表總筆數
$sqlTotal = "SELECT count(*) FROM `vendor`
             WHERE `vId` LIKE '%$search%'
             OR `vName` LIKE '%$search%'
             OR `vAccount` LIKE '%$search%'	
             OR `vPhone` LIKE '%$search%'
             OR `vAddress` LIKE '%$search%'
             OR `vEmail` LIKE '%$search%'
             ";
...
<body>
    <div class="wrapper">
        ...
        <div class="sidebar" data-color="blue" data-active-color="info">
            ...
            <?php require_once('./_require/member-left-aside.php') ?>
            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <form name="myForm" method="POST" action="vendor_list_search.php">
                    ...
                    <hr>
                    <div class="card-body">
                        <form method="POST" action="./vendor_deleteMultipleCheck.php">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT `vId`, `vName`, `vAccount`, `vPhone`, `vAddress`, `vEmail`
                                            FROM `vendor`
                                            WHERE `vId` LIKE ?
                                            OR `vName` LIKE ?
                                            OR `vAccount` LIKE ?	
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination justify-content-center">
                                    <li class="page-item">
                                        <a class="page-link" href="<?= "?search=" . $search . "&page=" ?>" aria-label="Previous">
                                    ...
                                    <?php } ?>
                                    <li class="page-item">
                                        <a class="page-link" href="<?= "?search=" . $search . "&page=" . $pagen ?>" aria-label="Next">
